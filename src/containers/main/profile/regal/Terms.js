  ...
  render() {
    ...
    return (
      <Animated.View style={[styles.container, style]}>
        <NavBar title="Terms of Service" back />
        <ScrollView style={styles.viewMain} indicatorStyle="white">
          ...
          <Label style={styles.text}>
            {'AGREEMENT TO E-SIGNATURES.  '}
          </Label>
          <Label style={styles.text}>
            {'WHEN YOU REGISTER AN ACCOUNT ON THE ROLZO SERVICES OR CLICK ON THE “COMPLETE RESERVATION,” BUTTON WHEN   A VEHICLE, YOU AGREE THAT YOU ARE INTENDING TO CREATE AN ELECTRONIC SIGNATURE AFFIRMING YOUR FULL UNDERSTANDING AND AGREEMENT TO BE LEGALLY BOUND BY ALL OF THESE TERMS OF SERVICE AND THAT YOU ARE LEGALLY PERMITTED TO USE AND ACCESS THE ROLZO SERVICES. '}
          </Label>
        </ScrollView>
        <NetInfoState />
      </Animated.View>
